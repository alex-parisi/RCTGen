// Verbatim port of the C-era image implementation, kept as-is against the
// modernized image.h. All rasterization rounding, mask application, PNG
// read/write, and palette quantization paths are left exactly as written
// -- this file is the source of truth for byte-equivalent sprite output
...
// math here (float-only literals, std::floor(float) instead of unqualified
...
*/
    ...
    int image_write_png(Image *image, ImagePalette *palette, FILE *file) {
        ...
        png_set_IHDR(png_ptr, info_ptr, image->width, image->height, 8, PNG_COLOR_TYPE_PALETTE, PNG_INTERLACE_NONE,
